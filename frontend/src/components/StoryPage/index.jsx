  ...
  useEffect(() => {
    async function all_follows() {
      ...
      responseData?.forEach((follow) => {
        resData?.authorId === follow?.userId &&
    ...
    async function all_likes() {
      ...
      currStoryLikesArr?.forEach((like) => {
        if (like?.userId === sessionUser?.id) {
          document
            .getElementById("loggedFullHeart")
            ?.setAttribute("style", "display:block;");
          document
            .getElementById("loggedEmptyHeart")
            ?.setAttribute("style", "display:none;");
          document
            .getElementById("loggedOutFullHeart")
            ?.setAttribute("style", "display:none;");
          document
            .getElementById("loggedOutEmptyHeart")
            ?.setAttribute("style", "display:none;");
            ...
            <table className="smallStoryTable">
              <tr className="smallStoryTr">
                ...
                <td className="smallStoryTd">
                  <table>
                    <tr>
                      <td className="smallStoryTitle">{`${currentStory?.title}`}</td>
                    </tr>
                    <tr>
                      <NavLink
                        className="smallStoryAuthor"
                        to={`/users/${userId}`}
                      >
                    ...
                    <tr>
                      <td className="smallStoryBody">{`${currentStory?.body}`}</td>
                    </tr>
                    <br />
                    <tr className="likesContainer">
                      ...
                      <i
                        className="far fa-heart"
                        id="loggedOutEmptyHeart"
                        style={{ display: "none" }}
                      ></i>
                      <i
                        className="fas fa-heart"
                        id="loggedOutFullHeart"
                        style={{ display: "none" }}
                      ></i>
                      <span>
                        {"\u00A0\u00A0"}
                        {` ${allLikes?.length} ${
                          allLikes?.length === 1 ? "like" : "likes"
                        }`}
                      </span>
                    </tr>
                  </table>
                  ...
                  {currentUser?.id === currentUserId && (
                    <button
                      className="storyPageDeleteButton"
                      onClick={() => {
