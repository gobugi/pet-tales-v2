...
const CommentsFromAStory = () => {
  ...
  const allCommentsFromStory = commentsArr.filter(
    (comment) => comment?.storyId === currentStory?.id
  );
        ...
        {sessionUser && (
          <div className="storyCommentsDiv">
            {hideBtn && (
              ...
              >
                <span id="newComment"> New comment</span>
              </i>
            )}
            ...
            {showMenu && (
              <div className="commentFormDiv">
                <form onSubmit={handlePost}>
                  ...
                  <button onClick={cancelMenu} type="button">
                    Cancel
                  </button>
              ...
              <table className="storyCommentTable">
                <tr className="storyCommentTr">
                  ...
                  <td className="storyCommentTd">
                    <table>
                      <tr>
                        <td className="storyCommentTitle"></td>
                      </tr>
                      <tr>
                        <NavLink
                          id="storyCommentAuthor"
                          to={`/users/${comment.userId}`}
                        >
                          <td className="storyCommentAuthor">{`${
                            usersArr.find(
                      ...
                      <tr>
                        <td id="storyCommentBody">{`${comment.body}`}</td>
                      </tr>
