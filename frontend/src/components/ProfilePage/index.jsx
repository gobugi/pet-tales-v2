  ...
  useEffect(() => {
    async function all_follows() {
      ...
      setFollowingUsernames(
        followingUsernamesArr?.sort(function (a, b) {
          return a?.username
            ?.toLowerCase()
      ...
      setFollowerUsernames(
        followerUsernamesArr?.sort(function (a, b) {
          return a?.username
            ?.toLowerCase()
            ?.localeCompare(b?.username?.toLowerCase());
        })
      ...
      responseData?.forEach((follow) => {
        +userId === follow?.userId &&
          sessionUser?.id === follow?.followerId &&
          currFollowArr?.push(follow);
      });
  ...
  return (
    <div className="profileDiv">
      <div
        ...
        style={{
          backgroundImage:
            "url(https://raw.githubusercontent.com/gobugi/pet-tales/main/frontend/public/images/profilebanner.jpg)",
          backgroundRepeat: "no-repeat",
          backgroundSize: "100%",
        }}
      >
        <div className="bannerDarkOverlay">
          <div id={`welcome`}>{currentUserId === +userId && `Welcome`}</div>
      ...
      <div className="profileStoriesContainer">
        <h2 className="profileStoriesTitle">
          ~ {currentUserId === +userId ? "My" : `${author}'s`} stories ~
        </h2>
        ...
        {currentUserId !== +userId && <br />}
        {currentUserId !== +userId && <hr />}
        {currentUserId !== +userId && <br />}
        {currentUserId !== +userId && <br />}
                ...
                <tr className="profileStoryTr">
                  ...
                  <td className="profileStoryTd">
                    <table>
                      ...
                      <tr>
                        <td className="profileStoryBody">{story.body}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
