  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage:
            "url(https://raw.githubusercontent.com/gobugi/pet-tales/main/frontend/public/images/heroimage.png)",
        ...
        <table className="homeStoriesTable">
          <tbody className="homeStoriesTbody">
            {fourRandomStories.map((story) => (
              <table key={story.id} className="homeStoryTable">
                <tr className="homeStoryTr">
                  ...
                  <td className="homeStoryTd">
                    <table>
                      ...
                      <tr>
                        <NavLink
                          className="homeStoryAuthor"
                          to={`/users/${story.authorId}`}
                        >
                          <td className="homeStoryAuthor">{`by ${
                            usersArr.find(
                      ...
                      <tr>
                        <td className="homeStoryBody">{story.body}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
